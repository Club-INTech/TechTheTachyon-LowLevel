...
void ORDER_grnd::impl(Args args)
{
    ...
    MOVE_ARM(args[0],
             ...
             arm->setPosition(positionSolGauche);
    )
}
void ORDER_grndRight::impl(Args args)
{
    ActuatorsMgr& manager = ActuatorsMgr::Instance();
    MOVE_ARM(args[0],
             arm->setPosition(positionSolIntermediaire);
...
void ORDER_acc7Depot::impl(Args args)  //entry position (594-190, 340)
{
    ActuatorsMgr& manager = ActuatorsMgr::Instance();
    MOVE_ARM(args[0],
            arm->setPositionNoRetry(positionAccelerateur7Middle3);
            arm->setPositionNoRetry(positionAccelerateur7MiddleDepot);
    )
}
...
void ORDER_deposePaletZoneDep::impl(Args args)
{
    ActuatorsMgr& manager = ActuatorsMgr::Instance();
    MOVE_ARM(args[0],
