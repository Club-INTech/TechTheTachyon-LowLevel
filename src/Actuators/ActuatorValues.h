...
const static float positionDistributeur[3] = {240.00f, 115.00f, 135.0f};
...
const static float positionSolGauche[3] = { /*Valeur de test:*/ 278.0f+10 /*272.0f*/, 97.0f+5-3, 180.0f};
