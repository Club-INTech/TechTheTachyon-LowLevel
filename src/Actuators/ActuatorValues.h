...
static float positionStockageSecondaire[3] = { 140.00f, 70.00f, 50.00f};
static float positionIntermediaire[3] = {195.18f, 249.83f, 82.19f};
static float positionIntermediaireSecondaire[3] = {140.00f, 75.00f, 55.00f};
static float positionIntermediaireSecondaire2[3] = {240.00f, 75.00f, 55.00f};
