...
const static float positionPreDistributeur[3] = {235.664001f, 77.000000f, /*103.575996f*/75.0f};//{246.46f, 85.00f, 100.00f};
const static float positionDistributeur[3] = {250.00f, 115.00f, 135.0f+10.0f};
