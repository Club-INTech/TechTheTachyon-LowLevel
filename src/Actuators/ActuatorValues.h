...
const static float positionAccelerateurMiddle[3] = {200.0f, 90.0f, 135.0f};
const static float positionAccelerateurMiddle2[3] = {210.0f, 90.0f, 135.0f};
const static float positionAccelerateurMiddle3[3] = {210.0f, 85.0f, 140.0f};
const static float positionAccelerateurMiddleDepot[3] = {220.0f, 90.0f, 135.0f};
